...
int main(int argc, char* argv[]) {
    ...
    outfile.open(argv[3]);
    ofstream timingFile;
    timingFile.open(argv[4]);

    vector<long long> input(100);

    auto start = std::chrono::high_resolution_clock::now();
    auto stop = std::chrono::high_resolution_clock::now();
    auto totalTime = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
    ...
    for (int i = 0; i < trials; i++) {
        ...
        outfile << KaramkarKarp(input) << ",";
        stop = std::chrono::high_resolution_clock::now();
        totalTime = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
        timingFile << totalTime.count() << ",";

        start = std::chrono::high_resolution_clock::now();
        outfile << repeatedRandom(input) << ",";
        stop = std::chrono::high_resolution_clock::now();
        totalTime = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
        timingFile << totalTime.count() << ",";

        start = std::chrono::high_resolution_clock::now();
        outfile << hillClimbing(input) << ",";
        stop = std::chrono::high_resolution_clock::now();
        totalTime = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
        timingFile << totalTime.count() << ",";

        start = std::chrono::high_resolution_clock::now();
        outfile << simulatedAnnealing(input) << ",";
        stop = std::chrono::high_resolution_clock::now();
        totalTime = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
        timingFile << totalTime.count() << ",";

        start = std::chrono::high_resolution_clock::now();
        outfile << ppRepeatedRandom(input) << ",";
        stop = std::chrono::high_resolution_clock::now();
        totalTime = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
        timingFile << totalTime.count() << ",";

        start = std::chrono::high_resolution_clock::now();
        outfile << ppHillClimbing(input) << ",";
        stop = std::chrono::high_resolution_clock::now();
        totalTime = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
        timingFile << totalTime.count() << ",";

        start = std::chrono::high_resolution_clock::now();
        outfile << ppSimulatedAnnealing(input);
        stop = std::chrono::high_resolution_clock::now();
        totalTime = std::chrono::duration_cast<std::chrono::microseconds>(stop - start);
        timingFile << totalTime.count();
